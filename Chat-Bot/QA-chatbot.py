...
def get_gemini_response(question):
    response = client.models.generate_content(
        model="gemini-2.5-flash-lite",  #This is very lite and we get free limited requests for users 
        contents=question
    )
...
user_input = st.text_input("Your question:")    #here user's question will be stored
...
st.subheader("Chat History")    #this is all about chat history
